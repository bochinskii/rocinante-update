  ...
  Drupal.behaviors.osDeltaReady = {
    attach: function (context, settings) {
      ...
      function dynamicPanel() {
       ...
       $('.views-field-field-button-top a').click(function(){$('html, body').animate({ scrollTop: 0 }, 1100);return false;});
       function sliderResize() {
          var slBody = $('.sliderBody').height();;
          var slImg = $('img.slImg').height();
            if (slImg < slBody) $('.swiper-container2').height(slBody);
            if (slImg > slBody) $('.swiper-container2').height(slImg);
          }
          sliderResize();
          dynamicPanel();
      ...
      $(window).scroll(function() {
        ...
        var section1Top = 0;
        var section3Top = page3.offset().top - ((page4.offset().top - page3.offset().top) / 2);
        var section6Top = page6.offset().top - (($(document).height() - page6.offset().top) / 2);
      });
